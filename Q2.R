...
auto.arima(ts2_adj)
which.max(acf(ts.log.d, lag.max = 100)$acf[-1])
...
mod_test1 <- arima(ts2_adj, order = c(4,1,2), seasonal = list(order = c(1, 0, 1), period = 52))
mod_test2 <- arima(ts2_adj, order = c(4,2,2), seasonal = list(order = c(1, 0, 1), period = 52))
mod_test3 <- arima(ts2_adj, order = c(4,1,2))
mod_test4 <- arima(ts2_adj, order = c(5,1,2), seasonal = list(order = c(1, 0, 1), period = 52))
mod_test5 <- arima(ts2_adj, order = c(5,1,2))
mod_test6 <- arima(ts2_adj, order = c(4,1,1), seasonal = list(order = c(1, 0, 1), period = 52))
