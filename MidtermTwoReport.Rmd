...
```{r, echo=FALSE, fig.cap= 'Plot of Original Data', fig.align = 'center'}
plot(ts1, type = "l")
```
...
```{r, echo=FALSE, fig.cap= 'Plot of Log Data Shifted Up 1.5', fig.align = 'center'}
...
```{r, echo=FALSE, fig.cap= 'Plot of the Differenced Log Data', fig.align = 'center'}
...
```{r, echo=FALSE, fig.cap= 'ACF of Log Transformed Data', fig.align = 'center'}
#plotted acf
acf(ts3)
```
```{r, echo=FALSE, fig.cap= 'PACF of Log Transformed Data', fig.align = 'center'}
pacf(ts3)
```
